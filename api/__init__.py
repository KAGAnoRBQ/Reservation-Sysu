...
from api.device import add_device, delete_device
from api.achievement import add_achievement, delete_achievement
...
from api.device_rent import rent_device, delete_device_rent, return_device
